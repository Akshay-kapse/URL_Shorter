        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li><Link href="/shorten" className="hover:text-white transition-colors duration-200">URL Shortener</Link></li>
                  <li><Link href="/admin" className="hover:text-white transition-colors duration-200">Analytics</Link></li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><Link href="#" className="hover:text-white transition-colors duration-200">Contact Us</Link></li>
            ...
            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
              <p>&copy; 2025 UrlShorter. All rights reserved. Built with ❤️ using Next.js.</p>
            </div>
          </div>
        </footer>
      </body>
